...
function LoadJSCode(e, t, n) {
    if (!Math.fround && n && "asmUrl" == n.id) {
        ...
        for (var o = {
            ...
            }, i = ["EMSCRIPTEN_START_ASM", "EMSCRIPTEN_START_FUNCS", "EMSCRIPTEN_END_FUNCS"], a = "var", r = "global.Math.fround;", s = 0, d = o.LOOKING_FOR_MODULE, l = 0, u = 0; d <= o.SCANNING_MODULE_FUNCTIONS && s < e.length; s++)
            ...
            if (u && 40 == e[s]) {
                ...
                if (c == u) {
                    var f = e[s - 1 - c];
                    if (36 > f || f > 36 && 48 > f || f > 57 && 65 > f || f > 90 && 95 > f || f > 95 && 97 > f || f > 122)
                        for (; c; c--) e[s - c] = 32
                }
            }
        } else {
...
function SetIndexedDBAndLoadCompressedJS(e) {
    SetIndexedDBAndLoadCompressedJS.called || (SetIndexedDBAndLoadCompressedJS.called = !0, Module.indexedDB = e, Module.wasmBinaryFile && "object" == typeof Wasm ? LoadCompressedFile(Module.wasmBinaryFile, function(e) {
        Module.wasmBinary = e, LoadCompressedJS(Module.codeUrl, null, {
            id: "codeUrl"
        })
    ...
    return function e(t, n, o) {
        ...
        7: [function(e, t, n) {
            ...
            t.exports = function(e, t) {
                ...
                n = e.state, a = e.next_in, E = e.input, r = a + (e.avail_in - 5), s = e.next_out, D = e.output, d = s - (t - e.avail_out), l = s + (e.avail_out - 257), u = n.dmax, c = n.wsize, f = n.whave, h = n.wnext, m = n.window, p = n.hold, b = n.bits, w = n.lencode, g = n.distcode, v = (1 << n.lenbits) - 1, k = (1 << n.distbits) - 1;
                e: do {
        ...
        8: [function(e, t, n) {
            ...
            function u(e) {
                if (ge) {
                    ...
                    for (y(S, e.lens, 0, 288, p, 0, e.work, {
                            bits: 9
                        }), t = 0; 32 > t;) e.lens[t++] = 5;
                    y(x, e.lens, 0, 32, b, 0, e.work, {
                        bits: 5
                    }), ge = !1
                }
            ...
            function f(e, t) {
                var n, i, a, r, s, d, l, f, h, m, p, b, me, pe, be, we, ge, ve, ke, ye, _e, Se, xe, Me, Ce = 0,
                    Ee = new w.Buf8(4),
                ...
                e: for (;;) switch (n.mode) {
                    ...
                    case ne:
                        if (d >= 6 && l >= 258) {
                            e.next_out = s, e.avail_out = l, e.next_in = r, e.avail_in = d, n.hold = f, n.bits = h, k(e, p), s = e.next_out, a = e.output, l = e.avail_out, r = e.next_in, i = e.input, d = e.avail_in, f = n.hold, h = n.bits, n.mode === W && (n.back = -1);
                            break
                        }
                ...
                return e.next_out = s, e.avail_out = l, e.next_in = r, e.avail_in = d, n.hold = f, n.bits = h, (n.wsize || p !== e.avail_out && n.mode < ce && (n.mode < de || t !== M)) && c(e, e.output, e.next_out, p - e.avail_out) ? (n.mode = fe, U) : (m -= e.avail_in, p -= e.avail_out, e.total_in += m, e.total_out += p, n.total += p, n.wrap && p && (e.adler = n.check = n.flags ? v(n.check, a, p, e.next_out - p) : g(n.check, a, p, e.next_out - p)), e.data_type = n.bits + (n.last ? 64 : 0) + (n.mode === W ? 128 : 0) + (n.mode === te || n.mode === X ? 256 : 0), (0 === m && 0 === p || t === M) && Se === D && (Se = A), Se)
            }
            ...
            var p, b, w = e("../utils/common"),
                ...
                we = be,
                ge = !0;
            n.inflateReset = r, n.inflateReset2 = s, n.inflateResetKeep = a, n.inflateInit = l, n.inflateInit2 = d, n.inflate = f, n.inflateEnd = h, n.inflateGetHeader = m, n.inflateInfo = "pako inflate (from Nodeca project)"
        }, {
            "../utils/common": 1,
            "./adler32": 3,
            "./crc32": 5,
        ...
        9: [function(e, t, n) {
            ...
            t.exports = function(e, t, n, m, p, b, w, g) {
                ...
                if (e === s ? (T = G = w, x = 19) : e === d ? (T = u, Z -= 257, G = c, H -= 257, x = 256) : (T = f, G = h, x = -1), N = 0, I = 0, R = L, S = b, A = U, B = 0, y = -1, z = 1 << U, _ = z - 1, e === d && z > a || e === l && z > r) return 1;
                for (var j = 0;;) {
                    j++, M = R - B, w[I] < x ? (C = 0, E = w[I]) : w[I] > x ? (C = G[H + w[I]], E = T[Z + w[I]]) : (C = 96, E = 0), v = 1 << R - B, k = 1 << A, L = k;
                    do k -= v, p[S + (N >> B) + k] = M << 24 | C << 16 | E | 0; while (0 !== k);
                    for (v = 1 << R - 1; N & v;) v >>= 1;
    ...
    function() {
        var e = function(e) {
            ...
            function n() {
                ...
                Module.addRunDependency("datafile_build.data"), Module.preloadResults || (Module.preloadResults = {}), Module.preloadResults[a] = {
                    fromCache: !1
                }, l ? (o(l), l = null) : u = o
            }
            var o;
